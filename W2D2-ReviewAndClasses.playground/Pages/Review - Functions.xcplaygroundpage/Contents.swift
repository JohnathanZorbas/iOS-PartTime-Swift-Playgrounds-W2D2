...
func speedDescription(kph: Double) -> String {
    if kph > 30 {
        return ("Whoa slow down buddy, 35.9 km/h is too fast for this school zone!")
    } else if kph > 0 {
        return ("we are moving \(kph) k/hr")
    } else {
